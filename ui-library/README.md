...
2. 读 ui-library/tokens.css                       → 拿到 :root 变量
3. 读 ui-library/components-index.md              → 看清需要哪些组件
4. 复制 ui-library/components/*.html              → 直接拼装 prototype
5. 按 ui-library/binding-checklist.md             → 自检
```
